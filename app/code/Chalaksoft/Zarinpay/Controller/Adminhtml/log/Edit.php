...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Chalaksoft_Zarinpay::Log')
            ->addBreadcrumb(__('Chalaksoft Zarinpay'), __('Chalaksoft Zarinpay'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Chalaksoft\Zarinpay\Model\Log');
        ...
        $this->_coreRegistry->register('log', $model);
